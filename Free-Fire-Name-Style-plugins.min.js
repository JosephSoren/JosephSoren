...
(this,function() {
    return function(b) {
        ...
        return a.m=b,a.c=c,a.i=function(a) {
            return a
        },
        a.d=function(b,c,d) {
    ...
    ([function(a,b,c) {
        var d,e,f;
        !function(h,g) {
            e=[a,c(7)],void 0!==(f="function"==typeof(d=g)?d.apply(b,e):d)&&(a.exports=f)
        }
        (0,function(b,c) {
            "use strict";
            ...
            (),d=function() {
                ...
                },
                {
                    key:"selectFake",value:function() {
                        var c=this,a="rtl"==document.documentElement.getAttribute("dir");
                        ...
                        this.fakeElem.style.top=b+"px",this.fakeElem.setAttribute("readonly",""),this.fakeElem.value=this.text,this.container.appendChild(this.fakeElem),this.selectedText=(0,e.default)(this.fakeElem),this.copyText()
                    }
                },
                {
    ...
    function(b,c) {
        ...
        a.prototype= {
            ...
            emit:function(c) {
                ...
                [c]||[]).slice(),a=0,e=b.length;
                a<e;
                a++)b[a].fn.apply(b[a].ctx,d);
                return this
            },
            off:function(c,d) {
                var e=this.e||(this.e= {
                ...
                a=e[c],f=[];
                if(a&&d)for(var b=0,g=a.length;
                b<g;
                b++)a[b].fn!==d&&a[b].fn._!==d&&f.push(a[b]);
    ...
    function(a,b,c) {
        var d,e,f;
        !function(h,g) {
            e=[a,c(0),c(2),c(1)],void 0!==(f="function"==typeof(d=g)?d.apply(b,e):d)&&(a.exports=f)
        }
        (0,function(b,c,d,e) {
            "use strict";
            function a(a) {
            ...
            var i=a(c),f=a(d),j=a(e),k="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(a) {
                return typeof a
            }
            :function(a) {
                return a&&"function"==typeof Symbol&&a.constructor===Symbol&&a!==Symbol.prototype?"symbol":typeof a
            ...
            (),g=function(b) {
                ...
                (a,b),l(a,[ {
                    key:"resolveOptions",value:function() {
                        ...
                        this.action="function"==typeof a.action?a.action:this.defaultAction,this.target="function"==typeof a.target?a.target:this.defaultTarget,this.text="function"==typeof a.text?a.text:this.defaultText,this.container="object"===k(a.container)?a.container:document.body
                    }
                },
                {
                    key:"listenClick",value:function(a) {
                        var b=this;
                        this.listener=(0,j.default)(a,"click",function(a) {
                            return b.onClick(a)
                        })
                    }
                },
                {
                    key:"onClick",value:function(b) {
                        var a=b.delegateTarget||b.currentTarget;
                        this.clipboardAction&&(this.clipboardAction=null),this.clipboardAction=new i.default( {
                            action:this.action(a),target:this.target(a),text:this.text(a),container:this.container,trigger:a,emitter:this
                        })
                    }
                },
                {
                ...
                {
                    key:"defaultTarget",value:function(b) {
                        var a=h("target",b);
                ...
                },
                {
                    ...
                    key:"isSupported",value:function() {
                        var a=arguments.length>0&& void 0!==arguments[0]?arguments[0]:["copy","cut"],b=!!document.queryCommandSupported;
    ...
    function(a,c,b) {
        ...
        var f=b(4);
        a.exports=function(a,c,b,e,f) {
            return"function"==typeof a.addEventListener?d.apply(null,arguments):"function"==typeof b?d.bind(null,document).apply(null,arguments):("string"==typeof a&&(a=document.querySelectorAll(a)),Array.prototype.map.call(a,function(a) {
                return d(a,c,b,e,f)
            }))
        }
    },
    ...
    function(a,b) {
        a.exports=function(a) {
            ...
            if("SELECT"===a.nodeName)a.focus(),b=a.value;
                ...
                var c=window.getSelection(),e=document.createRange();
...
$(function() {
    $(".fancytext").keyup(function() {
        $(".fancytext").val($(this).val()),""!=$.trim($(this).val())?b($(this).val()):b("name-style")
    });
    var a=89;
    function b(b) {
        var c=forward(b).split("\n\n"),d=1;
        for($.each(c,function(a,b) {
            $("#copy_"+a).val(b),d++
        }),
        k=89;
        k<=a;
        k++)$("#copy_"+k).val(crazyWithFlourishOrSymbols(b))
    }
    $(".loadmore1").click(function() {
        $(this).html("loading..");
        var b=$.trim($(".fancytext").val());
        ""==b&&(b="name-style");
        for(var d=$(this),e=setInterval(function() {
            d.html("View More"),clearInterval(e)
        },
        1e3),c=1;
        c<=10;
        c++)fancyText='<input class="name-style" type="text"  value="'+crazyWithFlourishOrSymbols(b)+'" id="copy_'+a+'" readonly="readonly">',a++,$("#result").append(fancyText)
    })
})
